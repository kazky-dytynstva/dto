...
void main() {
  group('$PersonRoleDto', () {
    ...
    test('given enum value musician '
        'when checking name and index '
        'then values are correct', () {
      // Given
    ...
    test('given enum value translator '
        'when checking name and index '
        'then values are correct', () {
      // Given
    ...
    for (final roleStr in allRoles) {
      test('given string value "$roleStr" '
